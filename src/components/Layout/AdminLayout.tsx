...
export const AdminLayout: React.FC<AdminLayoutProps> = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`sticky top-0 z-50 border-b ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}
      >
        <div className='flex items-center justify-between px-3 sm:px-4 py-3'>
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <div className='flex items-center gap-2'>
              <div
                className={`w-8 h-8 rounded-lg flex items-center justify-center ${isDark ? 'bg-blue-600' : 'bg-blue-500'}`}
              >
          ...
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <div className='hidden sm:flex items-center gap-2'>
              <div
                className={`w-2 h-2 rounded-full ${isMaintenanceMode ? 'bg-red-500' : 'bg-green-500'}`}
              ></div>
              <span
                className={`text-sm font-medium ${isMaintenanceMode ? 'text-red-500' : 'text-green-500'}`}
              >
