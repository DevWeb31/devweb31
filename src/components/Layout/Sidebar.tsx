  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:translate-x-0 ${effectiveCollapsed ? 'w-16' : 'w-64'} lg:relative`}
      >
        <div
          className={`h-full flex flex-col ${isDark ? 'bg-gray-800' : 'bg-white'} border-r ${
        ...
        >
          ...
          >
            <div
              className={`flex items-center gap-2 ${effectiveCollapsed ? 'justify-center w-full' : ''}`}
            >
              <div
          ...
          {!effectiveCollapsed && (
            <div className='p-3 border-b border-gray-200 dark:border-gray-700'>
              <div
                className={`relative ${isDark ? 'bg-gray-700' : 'bg-gray-100'} rounded-lg`}
              >
          ...
          <nav className='flex-1 overflow-y-auto py-2'>
            {filteredMenuItems.map(item => (
              <div key={item.id}>
                ...
                {!effectiveCollapsed && (
                  <div
                    className={`px-3 py-2 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
                  >
                            ...
                            <div className='ml-6 space-y-1'>
                              {subItem.children.map(subSubItem => (
                                <button
                                  key={subSubItem.id}
                                  onClick={() =>
                                    handleSubItemClick(subSubItem.id)
                                  }
                                  className={`w-full flex items-center gap-3 px-3 py-2 text-left transition-colors ${
