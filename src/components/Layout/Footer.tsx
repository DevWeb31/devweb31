      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-gray-300 dark:text-gray-400 leading-relaxed'>
              Spécialiste en développement web et d'applications. Nous créons
              des solutions digitales modernes et performantes pour faire
        ...
        <div className='border-t border-gray-700 dark:border-gray-800 mt-8 pt-8 text-center text-gray-400 dark:text-gray-500'>
          <div className='flex items-center justify-center space-x-4'>
            <p>
              &copy; {new Date().getFullYear()} DevWeb31. Tous droits réservés.
            </p>
