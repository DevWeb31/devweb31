...
export const AdminContent: React.FC<AdminContentProps> = ({
  ...
  const DebugMaintenanceStatus = ({ isDark }: { isDark: boolean }) => {
    ...
    const createMaintenanceRecord = async () => {
      try {
        ...
        if (error) {
          setDbStatus(
            `❌ Erreur lors de la création de l'enregistrement: ${error.message}`
          );
          setDbValue('N/A');
        } else {
    ...
    return (
      <div
        className={`mt-3 p-3 rounded-lg border ${isDark ? 'bg-yellow-900/20 border-yellow-800' : 'bg-yellow-50 border-yellow-200'}`}
      >
        <div className='flex items-center gap-2 mb-2'>
          <DatabaseIcon className='h-4 w-4 text-yellow-600' />
          <span
            className={`text-sm font-medium ${isDark ? 'text-yellow-300' : 'text-yellow-800'}`}
          >
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4'>
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-blue-900' : 'bg-blue-100'}`}
                  >
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-green-900' : 'bg-green-100'}`}
                  >
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-orange-900' : 'bg-orange-100'}`}
                  >
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-purple-900' : 'bg-purple-100'}`}
                  >
            ...
            >
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                  <div
                    className={`w-3 h-3 rounded-full ${isMaintenanceMode ? 'bg-red-500' : 'bg-green-500'}`}
                  ></div>
                  <div>
                    <h3
      ...
      case 'maintenance':
        return (
          ...
          >
            ...
            <div
              className={`mt-3 p-3 rounded-lg text-sm ${isDark ? 'bg-blue-900/20 border border-blue-800' : 'bg-blue-50'}`}
            >
              <p className={`${isDark ? 'text-blue-300' : 'text-blue-800'}`}>
                <strong>ℹ️ Note :</strong> En mode maintenance, seuls les
                administrateurs peuvent accéder au site normal.
              </p>
            </div>
            ...
            {successMessage && (
              ...
              >
                ...
                <span
                  className={`text-sm ${isDark ? 'text-green-300' : 'text-green-800'}`}
                >
                  {successMessage}
                </span>
              </div>
      ...
      case 'domains':
        return (
          ...
          >
            ...
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-green-900' : 'bg-green-100'}`}
              >
      ...
      case 'media':
        return (
          ...
          >
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-purple-900' : 'bg-purple-100'}`}
              >
      ...
      case 'messages':
        return (
          ...
          >
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-orange-900' : 'bg-orange-100'}`}
              >
              ...
              <div>
                ...
                <p
                  className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
                >
                  Consultez et gérez les messages reçus via le formulaire de
                  contact
                </p>
              </div>
      ...
      case 'notifications':
        return (
          ...
          >
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-yellow-900' : 'bg-yellow-100'}`}
              >
      ...
      case 'integrations':
        return (
          ...
          >
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-blue-900' : 'bg-blue-500'}`}
              >
          ...
          >
            <div className='mb-4'>
              ...
              <p
                className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
              >
                Sélectionnez une section dans le menu pour commencer à gérer
                votre site
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-3 ${isDark ? 'bg-blue-900' : 'bg-blue-100'}`}
                >
                  <Power className='h-5 w-5 text-blue-600' />
                </div>
                <h3
                  className={`font-medium text-center ${isDark ? 'text-white' : 'text-gray-900'}`}
                >
                  Maintenance
                </h3>
                <p
                  className={`text-xs mt-1 text-center ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
                >
                  {isMaintenanceMode ? 'Activé' : 'Désactivé'}
                </p>
              </div>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-3 ${isDark ? 'bg-green-900' : 'bg-green-100'}`}
                >
                  <BarChart3 className='h-5 w-5 text-green-600' />
                </div>
                <h3
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-3 ${isDark ? 'bg-orange-900' : 'bg-orange-100'}`}
                >
                  <MessageSquare className='h-5 w-5 text-orange-600' />
                </div>
                <h3
  ...
  return <div className='flex-1'>{renderSection()}</div>;
};
