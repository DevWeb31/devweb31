    ...
    <>
      ...
      <div className='min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-md w-full space-y-8'>
          ...
          >
            <div
              className={`mx-auto h-16 w-16 rounded-full flex items-center justify-center ${isDark ? 'bg-blue-900' : 'bg-blue-100'}`}
            >
              <Lock
            ...
            <h2
              className={`mt-6 text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}
            >
