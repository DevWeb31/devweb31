  ...
  return (
    <>
      ...
      <div className='pt-16'>
        ...
        {/* Stats Section */}
        <section
          className={`py-16 ${isDark ? 'bg-gray-800 border-y border-gray-700' : 'bg-white border-y border-gray-100'}`}
        >
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
              ...
              >
                ...
                <div
                  className={`space-y-6 leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
                >
                  <p>
                    Fondé sur l'innovation et l'excellence technique, DevWeb31
                    accompagne les entreprises dans leur transformation
                    digitale. Nous créons des solutions sur mesure qui répondent
                    précisément aux besoins de nos clients.
                  </p>
                  <p>
                    Notre approche combine les dernières technologies avec une
                    méthodologie éprouvée pour livrer des projets performants,
                    évolutifs et maintenables. Nous privilégions la qualité, la
                    sécurité et l'expérience utilisateur dans chaque
                    réalisation.
                  </p>
                  <p>
                    Basés à Toulouse, nous intervenons partout en France et
                    accompagnons des entreprises de toutes tailles, des startups
                    aux grands groupes, dans la réalisation de leurs ambitions
                    digitales.
                  </p>
                </div>
              </motion.div>
        ...
        <section className={`py-20 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              >
                Maîtrise complète des technologies modernes pour créer des
                ...
                {[
                  {
                    ...
                    title: 'Analyse',
                    description:
                      'Compréhension approfondie de vos besoins et objectifs',
                  },
                  {
                    step: '02',
                    title: 'Conception',
                    description:
                      'Design UX/UI et architecture technique optimisés',
                  },
                  {
                    step: '03',
                    title: 'Développement',
                    description:
                      'Réalisation agile avec tests et validation continue',
                  },
                  {
                    step: '04',
                    title: 'Livraison',
