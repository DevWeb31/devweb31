  ...
  const services = [
    {
      ...
      description:
        'Sites web modernes, rapides et optimisés SEO pour votre présence en ligne.',
    },
    {
      icon: Smartphone,
      title: 'Applications Mobiles',
      description:
        'Applications natives et progressive web apps pour iOS et Android.',
    },
    {
      icon: ShoppingCart,
      title: 'E-commerce',
  ...
  const projects = [
    {
      ...
      description:
        'Boutique en ligne avec gestion des stocks et paiements Stripe',
        ...
        <section className='py-20 bg-gray-50 dark:bg-gray-800'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                Maîtrise des dernières technologies pour des solutions
                performantes
              </p>
            </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            >
              ...
              <p className='text-xl mb-8 text-blue-100 max-w-3xl mx-auto'>
                ...
                obtenir un devis personnalisé pour votre projet digital.
              </p>
              <Link
                to='/contact'
